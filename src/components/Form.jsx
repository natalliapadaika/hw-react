...
import { ADD_USERS } from "../reducers/usersReduser";
  ...
  return (
    <form onSubmit={addNewPost}>
      <div className="inputs">
        ...
        <label>
          Nik:{" "}
          <input required value={postUserName} onChange={onChangeUserName} />
        </label>
        <label>
        ...
        <label>
          Address:{" "}
          <input required value={postAddress} onChange={onChangeAddress} />
        </label>
      </div>
      <div>
